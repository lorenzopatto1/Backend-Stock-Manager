...
let AuthenticateMatrixService = class AuthenticateMatrixService {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ email, password, }) {
            const user = yield this.matrixesRepository.findByEmail(email);
            if (!user) {
...
AuthenticateMatrixService = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("MatrixesRepository")),
    __param(1, (0, tsyringe_1.inject)("GenerateMatrixesTokenProvider")),
    __param(2, (0, tsyringe_1.inject)("MatrixesRefreshTokenRepository")),
    __param(3, (0, tsyringe_1.inject)("HashProvider")),
    __metadata("design:paramtypes", [Object, IGenerateMatrixesTokenProvider_1.default, Object, Object])
], AuthenticateMatrixService);
exports.default = AuthenticateMatrixService;
